...
class Reservation {
 ...
 class ReservationSystemUI {
    ...
    public void start() {
        ...
        while (true) {
            System.out.println("1. Make a reservation of Consumers");
            System.out.println("2. View all reservations history of Consumers");
            System.out.println("3. Cancel a reservation of Consumer");
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.println("Reservation made with Consumers ID " + reservation.getId());
                    break;
                case 2:
                    System.out.println("Reservations of Consumers not Booked:");
                    for (Reservation r : reservationSystem.getReservations()) {
                        System.out.println(r.getId() + " - " + r.getName() + " - " + r.getDate() + " - " + r.getNumberOfGuests());
                    }
                    break;
                case 3:
                    System.out.print("Reservation cancel with given Id: ");
